...
XYDiagram.propTypes = {
	...
	labelFont: _react.PropTypes.string,
	labelSize: _react.PropTypes.number,
	labelColor: _react.PropTypes.string,
	centerText: _react.PropTypes.string,
	centerTextFont: _react.PropTypes.string,
	centerTextSize: _react.PropTypes.number,
	centerTextColor: _react.PropTypes.string,

	axisColor: _react.PropTypes.string,
	backgroundColor: _react.PropTypes.string,

	leftAxisXOffset: _react.PropTypes.number,
	rightAxisXOffset: _react.PropTypes.number,

	x: _react.PropTypes.array.isRequired,
	xStep: _react.PropTypes.number,
	xMin: _react2.default.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.func]),
	xMax: _react2.default.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.func]),
	xFactor: _react.PropTypes.number,
	xGridOrigin: _react.PropTypes.number,
	xGridSpacing: _react.PropTypes.number,
	xGridAtPoint: _react.PropTypes.bool,
	xGridColor: _react.PropTypes.string,
	xLabelOrigin: _react.PropTypes.number,
	xLabelSpacing: _react.PropTypes.number,
	xLabelAtPoint: _react.PropTypes.bool,
	xLabelFunc: _react.PropTypes.func,
	xLabelNoOverlapCheck: _react.PropTypes.bool, // overlap checks only work from left to right, disable if points are right to left

	y: _react.PropTypes.array.isRequired,
	yMin: _react.PropTypes.number,
	yMax: _react.PropTypes.number,
	yFactor: _react.PropTypes.number,
	yValuesPerX: _react.PropTypes.number, // show that number of bars per point, y.length == x.length * yValuesPerX
	yColor: _react.PropTypes.string,
	yOpacity: _react.PropTypes.number,
	yLabelColor: _react.PropTypes.string,
	yGridOrigin: _react.PropTypes.number,
	yGridSpacing: _react.PropTypes.number,
	yGridColor: _react.PropTypes.string,
	yLabelOrigin: _react.PropTypes.number,
	yLabelSpacing: _react.PropTypes.number,
	yLabelFunc: _react.PropTypes.func,
	yLabelAtPoint: _react.PropTypes.bool,
	yLineWidth: _react.PropTypes.number,
	yLineDashes: _react.PropTypes.string,
	markerSize: _react.PropTypes.number,
	yBars: _react.PropTypes.number,
	yAxisTitle: _react.PropTypes.string,

	y2: _react.PropTypes.array,
	y2Min: _react.PropTypes.number,
	y2Max: _react.PropTypes.number,
	y2Factor: _react.PropTypes.number,
	y2ValuesPerX: _react.PropTypes.number, // show that number of bars per point, y2.length == x.length * y2ValuesPerX
	y2Color: _react.PropTypes.string,
	y2Opacity: _react.PropTypes.number,
	y2LabelColor: _react.PropTypes.string,
	y2LabelOrigin: _react.PropTypes.number,
	y2LabelSpacing: _react.PropTypes.number,
	y2LabelFunc: _react.PropTypes.func,
	y2LabelAtPoint: _react.PropTypes.bool,
	y2LineWidth: _react.PropTypes.number,
	y2LineDashes: _react.PropTypes.string,
	markerSize2: _react.PropTypes.number,
	y2OnRightAxis: _react.PropTypes.bool,
	y2Bars: _react.PropTypes.number,
	y2AxisTitle: _react.PropTypes.string,

	y3: _react.PropTypes.array,
	y3Min: _react.PropTypes.number,
	y3Max: _react.PropTypes.number,
	y3Factor: _react.PropTypes.number,
	y3ValuesPerX: _react.PropTypes.number, // show that number of bars per point, y3.length == x.length * y3ValuesPerX
	y3Color: _react.PropTypes.string,
	y3Opacity: _react.PropTypes.number,
	y3LabelOrigin: _react.PropTypes.number,
	y3LabelSpacing: _react.PropTypes.number,
	y3LabelFunc: _react.PropTypes.func,
	y3LineWidth: _react.PropTypes.number,
	y3LineDashes: _react.PropTypes.string,
	markerSize3: _react.PropTypes.number,
	y3Bars: _react.PropTypes.number,

	y4: _react.PropTypes.array,
	y4Min: _react.PropTypes.number,
	y4Max: _react.PropTypes.number,
	y4Factor: _react.PropTypes.number,
	y4Color: _react.PropTypes.string,
	y4Opacity: _react.PropTypes.number,
	y4LabelOrigin: _react.PropTypes.number,
	y4LabelSpacing: _react.PropTypes.number,
	y4LabelFunc: _react.PropTypes.func,
	y4LineWidth: _react.PropTypes.number,
	y4LineDashes: _react.PropTypes.string,
	markerSize4: _react.PropTypes.number,

	bgValues: _react.PropTypes.array,
	bgColorFunc: _react.PropTypes.func,

	onClickMarker: _react.PropTypes.func,
	selectedIndex: _react.PropTypes.number,
	selectedMarkerSize: _react.PropTypes.number,
	selectedMarkerColor: _react.PropTypes.string,
	leftMarkerX: _react.PropTypes.number,
	leftMarkerColor: _react.PropTypes.string,
	leftMarkerDragged: _react.PropTypes.func,
	rightMarkerX: _react.PropTypes.number,
	rightMarkerColor: _react.PropTypes.string,
	rightMarkerDragged: _react.PropTypes.func,
	leftRightMarkerCoverColor: _react.PropTypes.string,
	leftRightMarkerCoverOpacity: _react.PropTypes.number,
	leftRightMarkerWidth: _react.PropTypes.number,

	extraPointsX: _react.PropTypes.array,
	extraPointsY: _react.PropTypes.array,
	extraPointsSize: _react.PropTypes.number,
	extraPointsColor: _react.PropTypes.string
};
...
var _XYDiagram = require("./XYDiagram");
